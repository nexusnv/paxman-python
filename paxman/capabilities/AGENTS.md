...
## NOTES
- `__init__.py` exports all twenty-five shipped capabilities; completeness is enforced by `tests/unit/test_capability_exports.py`. IBAN, ISSN, ISIN, DOI, and LEI are the minimal-surface members (1 grammar + 1–2 rules each).
