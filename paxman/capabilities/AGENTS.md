...
## NOTES
- `__init__.py` exports all twenty-one shipped capabilities; completeness is enforced by `tests/unit/test_capability_exports.py`. IBAN and ISSN are the minimal-surface members (1 grammar + 1 rule each).
