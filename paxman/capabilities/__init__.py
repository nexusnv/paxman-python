...
_LAZY: dict[str, tuple[str, str]] = {
    ...
    "Domain": ("paxman.capabilities.Domain.capability", "DomainCapability"),
    ...
    "ISNI": ("paxman.capabilities.ISNI.capability", "ISNICapability"),
...
if TYPE_CHECKING:
    ...
    from paxman.capabilities.Domain.capability import DomainCapability as Domain
    ...
    from paxman.capabilities.ISNI.capability import ISNICapability as ISNI
