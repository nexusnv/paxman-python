...
| **ISNI** | Public-identity identifiers (ISO 27729) | spaced quads, compact, hyphenated, `ISNI` labels, `isni.org` URIs, `urn:isni:` carriers | spaced display (`"0000 0001 2103 2683"`) |
