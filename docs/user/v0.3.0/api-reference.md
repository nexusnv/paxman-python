...
| `RecognitionError` | internal bug | Grammar raised or returned a bad span/raw\_text. Fields: `rule`, `original_error` (`None` on structural failure) |
